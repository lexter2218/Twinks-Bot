...
class GuessTheNumber:
	...
	def user_response(self, message):
		...
		if not exists("palaro/data"):
			os.mkdir("palaro/data")

		#=========================Creating Database=========================
		database_path_file = f"palaro/data/#{message.guild.id}.db"
		active_games_db = SqliteDatabase(f"{database_path_file}")
		...
		class GuessTheNumber(Model):
			...
			class Meta:
				database = active_games_db

		#=========================Connecting to Database=========================
		active_games_db.connect()
		active_games_db.create_tables([GuessTheNumber])
